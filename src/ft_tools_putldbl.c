...
/*   Updated: 2021/04/05 23:59:11 by cyrlemai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Note: Terrible size management with that "power = ..." line >_<
*/
					...
					const char *base_exp)
{
	...
	written = 0;
	base_len = ft_strlen(base_exp) - 1;
	power = (get_base_exp(n, base_len) < 0) ? 0 : get_base_exp(n, base_len);
